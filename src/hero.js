        ...
        <div className="hero-section">
            <div className='overl'>
                ...
                <div className="hero-2">
                    Our lessons are as simple as posible for beginners,<br/>but also engaging for non beginners. We serve <br/>you with our 5 years of experience.
                </div>
                <button className="button-section" id="howto">Getting Started</button>
            </div>
        </div>
    );
}
